...
mode={'mode':'train', 'auto_bslr': False, 'all':True, 'search':'novelty', 'distance': 0, 'novel':2, 'lifted':True} # lifted batch size 8, learning rate 0.005, raise up numerical issue.
