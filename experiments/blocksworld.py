...
mode={'mode':'train', 'auto_bslr': False, 'all':False, 'search':'astar', 'distance': 0, 'novel':0, 'lifted':False} # lifted batch size 8, learning rate 0.005, raise up numerical issue.
