...
if __name__ == "__main__":
    ...
    repeats = 3
    modes=[
        {'domain':'gripper', 'mode':'train', 'search':'astar', 'all':False, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'astar', 'all':False, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'astar', 'all':False, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'astar', 'all':True, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'bfs', 'all':False, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'bfs', 'all':False, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'bfs', 'all':True, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'novelty', 'all':True, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'gripper', 'mode':'train', 'search':'novelty', 'all':True, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
    ]
    ...
    train_problem_pddls = []
    for i in range(1, 6):
        train_problem_pddls.append("problems/gripper-n{}.pddl".format(i))
    ...
    for i in range(repeats):
        ...
        for i in range(6, 26, 4):
            valid_problem_pddls.append("problems/gripper-n{}.pddl".format(i))
    ...
    test_problem_pddls = []
    for i in range(6, 26):
        if "problems/gripper-n{}.pddl".format(i) not in used_problems:
            test_problem_pddls.append("problems/gripper-n{}.pddl".format(i))
