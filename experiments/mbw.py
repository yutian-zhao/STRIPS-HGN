...
if __name__ == "__main__":
    ...
    repeats = 3
    modes=[
        {'domain':'mbw', 'mode':'train', 'search':'astar', 'all':False, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'astar', 'all':False, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'astar', 'all':False, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'astar', 'all':True, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'bfs', 'all':False, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'bfs', 'all':False, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'bfs', 'all':True, 'novel':0, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'novelty', 'all':True, 'novel':2, 'lifted':0, 'distance': 0, 'bound': 600, 'auto_bslr': False},
        {'domain':'mbw', 'mode':'train', 'search':'novelty', 'all':True, 'novel':2, 'lifted':1, 'distance': 0, 'bound': 600, 'auto_bslr': False},
    ]
    ...
    train_problem_pddls = sorted(['3/'+ p for p in os.listdir("../benchmarks/mbw/3")])[:10]+ \
        sorted(['4/'+p for p in os.listdir("../benchmarks/mbw/4")])[:10]+ \
        sorted(['5/'+p for p in os.listdir("../benchmarks/mbw/5")])[:10]
    ...
    for i in range(repeats):
        ...
        valid_problem_pddls = []
        for i in range(5, 9):
            valid_problem_pddls += sorted(random.sample([str(i)+'/'+ p for p in os.listdir("../benchmarks/mbw/"+str(i))], k=2))
